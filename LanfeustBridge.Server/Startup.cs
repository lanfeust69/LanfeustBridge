...
public class Startup
{
    ...
    public void ConfigureServices(IServiceCollection services)
    {
        ...
        {
            Serilog.Log.Information("Skipping Google authentication as client-id is not configured");
        }
        else
        {
    ...
    public void Configure(IApplicationBuilder app, RoleManager<Role> roleManager, ILogger<Startup> logger)
    {
        if (IsDevelopment)
        {
